...
## Azure Blueprints & Landing Zones (2025)

- **Azure Blueprints**: Now part of Azure Deployment Environments
  - Provides predefined governance, policy and resource-structure templates
  - Enables repeatable deployment of standardized environments
- **Azure Landing Zones**: Best practice guidance for enterprise-scale deployments
  - Defines structure for subscriptions, resource groups, and networking
  - Implements security, governance, and connectivity patterns
  - Multiple variants: Cloud Adoption Framework Landing Zones, Enterprise-scale Landing Zones
- **Tag inheritance at management group level** (preview)
  - Apply tags at management group level that propagate to all nested subscriptions and resource groups
