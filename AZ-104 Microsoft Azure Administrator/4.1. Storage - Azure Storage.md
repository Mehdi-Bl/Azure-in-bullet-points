...
- Provides hierarchical namespace (default for new storage accounts)
...
- Supports GZRS and RA-GZRS replication options
- Supports Data Lake Storage Gen2
- ❗ Has a changing soft limit (500 TB)
  - Can contact Azure support and request higher limits (up to 5 PB)
...
- **Geo-Zone-Redundant Storage (GZRS)** - **NEW 2025**
  - Combines zone redundancy within primary region (like ZRS)
  - Asynchronous replication to secondary region (like GRS)
  - Only available for GPv2 storage accounts
- **Read-access Geo-Zone-Redundant Storage (RA-GZRS)** - **NEW 2025**
  - Same as GZRS, but provides read access to secondary region
  - Offers highest availability and durability for GPv2 accounts
