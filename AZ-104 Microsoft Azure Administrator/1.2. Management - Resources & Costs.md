...
- Tags are additional metadata that can be assigned to resources/resource groups.
  ...
  - Management groups now support tags (preview) to apply governance at scale
- E.g. `CostCenter = YHZ`
- Why?
  - Organize
  - Search
...
- Azure Policy can enforce required tags, and Azure Resource Graph enables tag-based queries across subscriptions

## Budgets and Cost Alerts

- Azure Cost Management allows creating budgets at subscription, resource group, or management group scope
- Set cost and forecast thresholds with monthly, quarterly, or annual budgets
- Budgets require at least one threshold and evaluate costs every 24 hours
- When thresholds are met, Azure sends email or webhook alerts
- Forecast alerts provide advance notice that spending may exceed the limit
- Budgets include reservation purchases and usage data

## Azure Savings Plans

- Microsoft introduced Azure Savings Plan for compute (2025)
- Reduces eligible compute usage costs by up to 65% in exchange for committing to hourly spend for 1 or 3 years
- Flexible - unused commitment is lost but does not affect runtime state
- Available to enterprise, MCA, or MPA agreements
...
- 📝 Use Azure Savings Plan for compute workloads
  - More flexible than reserved instances
  - Up to 65% savings for 1-3 year commitment
