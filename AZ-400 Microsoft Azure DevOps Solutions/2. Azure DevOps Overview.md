...
- **Azure Repos**
  ...
  - **Integration with GitHub**: Fine-grained permissions and Entra ID group support
- **Azure Pipelines**
  - Provides build & release services for continuous integration & delivery
  - **YAML-based pipelines**: Recommended over classic pipelines
  - **Multi-stage deployments**: Template-based architecture
  - **GitHub Actions integration**: Unified CI/CD workflows
- **Azure Boards**
  - Agile tools that support planning and tracking work items
  - **New Boards Hub (2025)**: Markdown support for work item comments
  - **GitHub integration**: Seamless project and issue tracking
- **Azure Test Plans**
  - Tools for testing your applications
  - **Azure Load Testing (2025)**: CI/CD integration with pass/fail criteria
- **Azure Artifacts**
  - Allows teams to work with `maven`, `npm` and `NuGet` packages
  - Same purpose as [JFrog Artifactory](https://jfrog.com/artifactory/)
  - **GitHub Packages integration**: Unified package management
- **Environment Management**
  - **Azure Deployment Environments**: On-demand test environments (2025)
