...
## Pipeline as code (YAML - 2025 Best Practice)

- **Migrate from Classic to YAML**: All new pipelines should use YAML
- Version-controlled infrastructure for pipelines
- **Schema** (Enhanced 2025):
...
- **Multi-stage Pipelines (2025)**:
  - Organize pipeline into Build, Test, and Deploy stages
  - Stage-level dependencies and conditions
  - Template-based architecture for reusability
  - Environment-specific deployments

- **Pipeline Structure**:
  - **Stages**: Highest level of organization (Build, Test, Deploy)
  - **Jobs**: Within stages, jobs run on agents
  - **Steps**: Individual tasks within jobs
  - **Tasks**: Predefined or custom actions
...
### Templates and Reusability (2025)

- **Template Files**: Create reusable pipeline components
- **Parameterization**: Pass parameters to templates
- **Example Template** (`templates/build.yml`):
...
### Variable Groups and Environments (2025)

- **Secure Variable Management**:
  - Variable groups for multi-pipeline values
  - Integration with Azure Key Vault
  - Environment-specific variables
  - Secret management through OIDC (recommended)
