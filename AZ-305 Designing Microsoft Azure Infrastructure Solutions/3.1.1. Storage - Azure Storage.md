...
## 2025 Storage Redundancy Options

### Geo-Zone-Redundant Storage (GZRS) - 2025
- **Redundancy**: 3 copies across 3 availability zones in primary region
- **Geo-Replication**: Automatic replication to secondary region
- **Durability**: 99.99999999999999% (16 nines) durability
- **RPO**: 15 minutes (asynchronous replication)
- **Use Cases**: Maximum durability with geographic distribution, disaster recovery

### Read-Access GZRS (RA-GZRS) - 2025
- **Primary**: Same as GZRS (3 zone copies)
- **Secondary**: Read access to secondary region during normal operations
- **Benefits**:
  - Read data from secondary region during outages
  - Geo-distributed applications
  - Read-heavy workloads
- **Cost**: Higher than GRS due to secondary read access
...
## 2025 Premium Storage Options

### Premium SSD v2 (2025)
- **Performance**: High-performance, low-latency block storage
- **Throughput**: Up to 80,000 IOPS and 2,000 MB/s per disk
- **Size**: 1 GB to 64 TB per disk
- **Best For**:
  - Mission-critical databases (SQL, Oracle, PostgreSQL)
  - High-performance analytics
  - Real-time transaction processing
- **Zonal**: Available across all availability zones
- **Pricing**: Pay for provisioned capacity and performance

## Storage Account Types (2025)

### Standard General-Purpose v2
- **Services**: Blob, Files, Queue, Table
- **Tiers**: Hot, Cool, Archive
- **Redundancy**: LRS, ZRS, GRS, RA-GRS, **GZRS, RA-GZRS**
- **Use Cases**: Most scenarios, flexible tiering

### Premium Options
- **Premium Block Blob**: High throughput, low latency for block blobs
- **Premium File Shares**: High IOPS, low latency for file shares
- **Performance**: Optimized for high-performance workloads

### Storage Tiers (2025)

#### Hot Access Tier
- **Frequency**: Frequently accessed data
- **Storage Cost**: Highest per-GB cost
- **Access Cost**: Lowest per-access cost
- **Use Cases**: Active data, frequent access

#### Cool Access Tier
- **Frequency**: Infrequently accessed data
- **Storage Cost**: Lower than hot tier
- **Access Cost**: Higher than hot tier
- **Use Cases**: Short-term backup, disaster recovery

#### Archive Access Tier
- **Frequency**: Rarely accessed data
- **Storage Cost**: Lowest per-GB cost
- **Access Cost**: Highest per-access cost (hours to rehydrate)
