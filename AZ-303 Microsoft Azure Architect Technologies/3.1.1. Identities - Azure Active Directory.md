...
**Note**: Azure Active Directory has been rebranded as **Microsoft Entra ID**. While the core concepts remain the same, terminology and some features may have evolved.
